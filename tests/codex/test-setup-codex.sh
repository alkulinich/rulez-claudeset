...
test_readme_documents_standalone_spec2pr_forecast() {
  ...
  assert_contains "one native subagent from the current tool" "$readme" "README documents one native subagent"
  ...
  assert_contains "Suggested split" "$readme" "README documents conditional split advice"
